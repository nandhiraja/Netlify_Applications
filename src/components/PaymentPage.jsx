                    ...
                    {!edcData ? (
                      ...
                      <>
                        <div className="edc-info">
                          ...
                          <div className="transaction-details">
                            <p><strong>Transaction ID:</strong> {edcData.transaction_id}</p>
                            <p><strong>Amount:</strong> ₹{(parseInt(edcData.amount) / 100).toFixed(2)}</p>
                            <p><strong>Provider:</strong> {edcData.provider}</p>
                          </div>
                        </div>
